...
-- If the earlier broad migration was already run, clear only auto-generated
-- ticket links outside this scoped window. This preserves manually edited URLs.
update public.events
set ticket_url = null
where ticket_url = 'https://www.edfringe.com/tickets/whats-on/' ||
  regexp_replace(
    regexp_replace(
